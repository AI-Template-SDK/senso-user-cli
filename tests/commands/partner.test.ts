...
describe("partner, when partner authentication rejects the key", () => {
...
describe("partner, resolving the <industry> argument", () => {
  ...
  it("exits 4 and quotes the name back when the search matches nothing", async () => {
    ...
    const res = await runCli(["partner", "industries", "summary", "Underwater Basket Weaving"]);
...
describe("partner industries list, on the wire", () => {
  ...
  it("passes --search through as the search parameter", async () => {
    ...
    await runCli(["partner", "industries", "list", "--search", "auto"]);

    expect(new URL(seen!.url).searchParams.get("search")).toBe("auto");
  });
});

describe("partner industries summary, on the wire", () => {
...
describe("partner industries brand, on the wire", () => {
  ...
  it("resolves a named industry before fetching the brand", async () => {
    ...
    const res = await runCli(["partner", "industries", "brand", "Automotive", "Acme"]);
...
describe("partner industries domain, on the wire", () => {
...
describe("partner industries prompt-metrics, on the wire", () => {
...
describe("partner glossary, on the wire", () => {
...
describe("partner industries list, on success", () => {
...
describe("partner industries summary, on success", () => {
